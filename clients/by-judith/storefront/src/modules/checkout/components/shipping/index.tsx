...
const Shipping: React.FC<ShippingProps> = ({
  ...
  const hasPickupOptions = _pickupMethods.length > 0
  ...
  useEffect(() => {
    ...
    setIsLoadingPrices(calculatedMethods.length > 0)
    ...
    if (calculatedMethods.length) {
      Promise.allSettled(
        ...
        for (const result of results) {
          if (result.status === "fulfilled" && result.value?.amount != null) {
            ...
            <div data-testid="delivery-options-container">
              <div className="pb-8 md:pt-0 pt-2">
                {hasPickupOptions && (
                  ...
                  >
                    <Radio
                      ...
                      className={clx(
                        "flex items-center justify-between text-small-regular cursor-pointer py-4 border rounded-[3rem] px-8 mb-2 hover:shadow-borders-interactive-with-active",
                        {
                ...
                <RadioGroup
                  ...
                  onChange={(v) => {
                    if (v) void handleSetShippingMethod(v, "shipping")
                  }}
                >
              ...
              <div data-testid="delivery-options-container">
                <div className="pb-8 md:pt-0 pt-2">
                  <RadioGroup
                    value={shippingMethodId}
                    onChange={(v) => {
                      if (v) void handleSetShippingMethod(v, "pickup")
                    }}
                  >
