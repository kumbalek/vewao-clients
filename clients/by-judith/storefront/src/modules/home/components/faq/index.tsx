...
const Faq = () => {
  ...
  return (
    <div className="w-full relative flex flex-col items-center py-12 small:py-24">
      <div className="w-full relative content-container max-w-7xl flex gap-8 justify-between flex-col">
        ...
        <div className="w-full small:w-1/2 large:w-1/3 max-w-[1080px]">
          <Thumbnail thumbnail={"/jh-about.webp"} size="full" />
        </div>
      </div>
    </div>
  )
